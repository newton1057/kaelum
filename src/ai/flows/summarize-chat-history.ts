...
/**
 * @fileOverview Summarizes a chat history to quickly catch up on previous conversations.
 *
...
Provide a concise summary that captures the main topics discussed and any key decisions or action items.`,
});
